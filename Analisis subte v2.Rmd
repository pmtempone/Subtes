...
print(interrupciones_promedio,n=126)

ggplot(data = interrupciones_promedio,mapping = aes(x=Mes,y=mean_interrupciones,group=FR1_LINEA))+geom_line(aes(colour = FR1_LINEA))+theme(text = element_text(size=10),
        axis.text.x = element_text(angle=90, vjust=1))+ xlab("Año-Mes")


paste("Interrupciones Promedio diarias de Septiembre fueron",mean(interrupciones_x_mes$Interrupciones[interrupciones_x_mes$FR1_FECHA>="2016-09-01"])
)
